    ...
    <div className="space-y-3">
      <div className="grid grid-cols-2 gap-2.5">
        ...
        <button
          ...
          className="flex items-center justify-center gap-2.5 px-4 py-2.5 rounded-xl bg-slate-950/80 hover:bg-slate-800 border border-slate-700 hover:border-slate-600 text-white text-xs font-semibold transition-all disabled:opacity-50 active:scale-[0.98]"
        >
